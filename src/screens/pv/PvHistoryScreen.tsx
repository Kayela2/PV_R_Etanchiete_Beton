// src/screens/pv/PvHistoryScreen.tsx
...
const PvHistoryScreen = () => {
  ...
  // Snapshots du plus récent au plus ancien
  const snapshots  = [...(pv.versions ?? [])].reverse();
  const total      = snapshots.length + 1; // +1 pour la version actuelle
  ...
  <div style={{
    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
        <span style={{
          fontSize: 13, fontWeight: 900, color: isCurrent ? "#E3000F" : "#111827",
        }}>
          Version {versionNum}
        </span>
        {isCurrent && (
