// src/modules/pv-beton/screens/HomeScreen.tsx
...
const HomeScreen = () => {
  ...
  return (
    <div style={{
      ...
      {pvList.length === 0 ? (
        <EmptyState onAdd={() => navigate("/apps/pv-beton/form")} />
      ) : (
        <>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {filtered.map((pv) => (
                <PvCard
                  key={pv.id}
                  pv={pv}
                  onClick={() => navigate("/apps/pv-beton/pv/" + pv.id)}
          ...
          {/* FAB */}
          <button onClick={() => navigate("/apps/pv-beton/form")} style={{
