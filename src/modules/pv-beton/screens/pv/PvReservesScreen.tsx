// src/modules/pv-beton/screens/pv/PvReservesScreen.tsx
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", backgroundColor: "#F3F4F6", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 11, color: "#6B7280", fontWeight: 600, marginBottom: 2 }}>Réserves</p>
          <p style={{
        ...
        <div style={{
          backgroundColor: "#E3000F", borderRadius: 100, padding: "4px 10px",
      ...
      <div style={{
        ...
        <div style={{ overflowY: "auto", padding: "16px 20px 40px", display: "flex", flexDirection: "column", gap: 18 }}>
          <div>
            ...
            <p style={{ fontSize: 14, color: "#374151", lineHeight: 1.7 }}>{reserve.detail}</p>
          </div>
          {mainPhotos.length > 0 && (
            <div>
              <p style={{
