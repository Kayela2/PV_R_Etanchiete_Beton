// src/modules/pv-beton/screens/pv/Step1InfoScreen.tsx
...
const Step1InfoScreen = () => {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    nextStep();
    navigate("/apps/pv-beton/form/step2");
  };
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  navigate(hasReserves ? "/apps/pv-beton/form/reserves" : "/apps/pv-beton/form/reserve");
                }}
                style={{
                  width: "100%",
