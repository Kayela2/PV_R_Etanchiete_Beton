// src/modules/pv-beton/screens/pv/ReserveFormScreen.tsx
...
const ReserveFormScreen = () => {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => navigate("/apps/pv-beton/form", { replace: true }), 300);
  };
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", height:"100%", backgroundColor:"#fff", position:"relative" }}>
      ...
      <div style={{ flex:1, overflowY:"auto", padding:"20px 20px 0", minHeight:0 }}>
          ...
          {locPhoto ? (
            <div style={{ position:"relative" }}>
              ...
              <div style={{ position:"absolute", top:8, right:8, display:"flex", gap:6 }}>
                <button onClick={() => setAnnotatingLocPhoto(true)} title="Annoter" style={{
                ...
                <button onClick={handleReplaceLocPhoto} title="Changer l'image" style={{
                  width:32, height:32, borderRadius:8,
                  backgroundColor:"rgba(255,255,255,0.9)", border:"none", cursor:"pointer",
                  display:"flex", alignItems:"center", justifyContent:"center",
                  boxShadow:"0 1px 4px rgba(0,0,0,0.15)",
                ...
                <button onClick={() => setLocPhoto(null)} title="Supprimer" style={{
                  width:32, height:32, borderRadius:8,
                  backgroundColor:"rgba(255,255,255,0.9)", border:"none", cursor:"pointer",
                  display:"flex", alignItems:"center", justifyContent:"center",
                  boxShadow:"0 1px 4px rgba(0,0,0,0.15)",
            ...
            <button onClick={handleAddLocPhoto} style={{
              width:"100%", height:100, borderRadius:16,
              border:"2px dashed #E5E7EB", backgroundColor:"#F3F4F6",
              display:"flex", flexDirection:"column",
              alignItems:"center", justifyContent:"center", gap:6,
        ...
        {reserves.length > 0 && (
          <button
            onClick={() => handleNavigateAway("/apps/pv-beton/form/reserves")}
            style={{
