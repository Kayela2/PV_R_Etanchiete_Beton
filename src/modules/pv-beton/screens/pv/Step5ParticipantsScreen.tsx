// src/modules/pv-beton/screens/pv/Step5ParticipantsScreen.tsx
...
const Step5ParticipantsScreen = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate("/apps/pv-beton/form/step6", { replace: true, state: { pvId: targetPvId } });
    } catch (err) {
      ...
      <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "flex", gap: 12, paddingBottom: 16 }}>
          ...
          <button
            ...
            disabled={saving}
            style={{
              flex: 2, backgroundColor: "#E3000F", color: "#fff",
