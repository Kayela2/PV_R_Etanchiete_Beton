// src/modules/pv-beton/screens/PvDetailScreen.tsx
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button
            onClick={() => navigate(`/apps/pv-beton/pv/${pv.id}/history`)}
      ...
      <div style={{
        ...
        {(pv.step1?.reserves?.length ?? 0) > 0 && (
          <Section title={`Réserves — ${pv.step1!.reserves!.length} / 8`}>
            ...
            <button
              onClick={() => navigate(`/apps/pv-beton/pv/${pv.id}/reserves`)}
              style={{
